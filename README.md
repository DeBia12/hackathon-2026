...
| `agents/` | Agenti Claude a runtime — SDK Anthropic, prompt chaining |
| `backend/supabase/` | Supabase self-hosted su Podman — Postgres, auth, API REST |
| `presentazione/` | Deck Reveal.js con tema Accenture, funziona offline |
| `docs/` | Decisioni architetturali e registro degli audit di accessibilità |
| `.claude/` | Agenti, skill e comandi condivisi dal team |
