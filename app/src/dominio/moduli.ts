...
const _lezioniInterne: Record<string, Lezione> = {
  ...
  l1b: {
    ...
    capisci: [
      ...
      "Nel tempo, se i prezzi crescono, lo stesso denaro compra meno cose. " +
        "Questo è il punto di partenza per capire l'inflazione.",
    ],
    prova: {
      componente: "potere-acquisto",
      consegna: "Sposta gli anni e guarda cosa succede al carrello della spesa.",
    },
    verifica: "v-l1b",
  },
  ...
  l2a: {
    ...
    capisci: [
      "L'inflazione è l'aumento generale e continuato dei prezzi nel tempo. " +
        "Non un singolo prezzo che sale: quasi tutti insieme.",
      "Quando c'è inflazione, i tuoi soldi comprano meno cose rispetto a prima. " +
        "Il tuo potere d'acquisto diminuisce, anche se hai le stesse banconote in mano.",
      "L'inflazione non è un fenomeno eccezionale: è una parte normale dell'economia moderna. " +
        "Conoscerla ti aiuta a capire cosa succede davvero al valore del tuo denaro nel tempo.",
    ],
    prova: {
      componente: "potere-acquisto",
      consegna:
        "Usa il cursore per simulare anni diversi di inflazione e osserva come " +
        "cambia quello che puoi comprare con la stessa cifra.",
    },
    verifica: "v-l2a",
  },
