...
export const CONCETTI: Readonly<Record<ConcettoId, Concetto>> = {
  ...
  "rischio": {
    ...
    inUnaRiga: "Il rischio è la possibilità che un investimento valga meno di quanto previsto: non può essere eliminato, solo gestito.",
    prerequisiti: ["risparmio"],
    lezione: "l4a",
  },
  "rendimento": {
  ...
  "diversificazione": {
    ...
    inUnaRiga: "Diversificare significa distribuire i risparmi su più strumenti diversi: se uno perde valore, gli altri possono compensare.",
    prerequisiti: ["rischio"],
    lezione: "l5a",
  },
  "prestito": {
