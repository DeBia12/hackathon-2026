...
const _DOMANDE: Record<DomandaId, Domanda> = {
  ...
  "v-l2a": {
    ...
    concetto: "inflazione",
    gemella: "r-l2a",
    testo: "Come si ottiene il numero che viene pubblicato come inflazione?",
    corretta: "c",
    opzioni: [
      {
        id: "a",
        testo: "Prendendo il prodotto che è rincarato di più nell’anno",
        lacuna: "inflazione",
        spiegazione: "Un singolo prezzo che schizza non è inflazione. Il dato pubblicato riguarda un insieme ampio di beni e servizi.",
      },
      {
        id: "b",
        testo: "Chiedendo alle famiglie quanto pensano di spendere in più",
        lacuna: "inflazione",
        spiegazione: "Non è una percezione: è una misura sui prezzi effettivamente rilevati nei punti vendita.",
      },
      {
        id: "c",
        testo: "Confrontando nel tempo quanto costa un paniere di beni e servizi, riassunto in un indice dei prezzi al consumo",
        spiegazione: "Si osserva lo stesso paniere in due momenti diversi e si misura di quanto è cambiato il suo costo complessivo. Il risultato è un indice.",
      },
      {
        id: "d",
        testo: "Sommando i prezzi di tutti i prodotti in vendita nel paese",
        lacuna: "inflazione",
        spiegazione: "Non si sommano tutti i prezzi: si segue un paniere rappresentativo, in cui ogni voce pesa in base a quanto incide sulla spesa media.",
      },
    ],
  },
  ...
  "v-l5a": {
    ...
    concetto: "diversificazione",
    gemella: "r-l5a",
    testo: "Che cosa fa la diversificazione al rischio?",
    corretta: "c",
    opzioni: [
      {
        id: "a",
        testo: "Lo elimina: un insieme diversificato non può perdere valore",
        lacuna: "rischio",
        spiegazione: "Nessun insieme è al riparo dalle perdite. La diversificazione non fa sparire il rischio.",
      },
      {
        id: "b",
        testo: "Lo sposta interamente sugli strumenti più stabili dell’insieme",
        lacuna: "diversificazione",
        spiegazione: "Il rischio non viene trasferito da uno strumento all’altro: resta, ma non dipende più da un solo nome.",
      },
      {
        id: "c",
        testo: "Lo distribuisce: un singolo evento sfavorevole pesa su una parte dell’insieme, non su tutto",
        spiegazione: "È la tesi della lezione. Distribuire invece di concentrare cambia quanto un singolo evento incide sul totale. Il rischio resta, ma non è più legato a un unico strumento.",
      },
      {
        id: "d",
        testo: "Lo trasforma in rendimento garantito",
        lacuna: "rendimento",
        spiegazione: "Nessuna scelta trasforma il rischio in un risultato garantito. La diversificazione riguarda come il rischio è distribuito, non il rendimento.",
      },
    ],
  },
  ...
  "v-l6a": {
    ...
    concetto: "prestito",
    gemella: "r-l6a",
    testo: "Due situazioni. Nella prima hai comprato una quota di un’azienda. Nella seconda hai prestato denaro alla stessa azienda. Quale delle due ti dà diritto a riavere il capitale entro una scadenza stabilita?",
    corretta: "b",
    opzioni: [
      {
        id: "a",
        testo: "La prima, perché possedere una quota è un diritto più forte",
        lacuna: "proprieta",
        spiegazione: "Chi possiede una quota partecipa ai risultati dell’azienda, buoni o cattivi, ma non ha né una scadenza né un rimborso stabilito.",
      },
      {
        id: "b",
        testo: "La seconda, perché chi presta denaro è un creditore",
        spiegazione: "È la distinzione al centro della lezione: il prestito definisce quanto ti viene restituito ed entro quando. La quota di proprietà no.",
      },
      {
        id: "c",
        testo: "Entrambe, perché in tutti e due i casi hai messo del denaro",
        lacuna: "prestito",
        spiegazione: "Mettere denaro non basta a definire il ruolo: cambia che cosa ricevi in cambio. Solo il prestito prevede una restituzione entro una scadenza.",
      },
      {
        id: "d",
        testo: "Nessuna delle due: la restituzione dipende sempre da come va l’azienda",
        lacuna: "prestito",
        spiegazione: "Per il creditore la restituzione è un impegno contrattuale con una scadenza. Può non essere onorata se l’emittente è in difficoltà, ma resta un impegno, non una partecipazione ai risultati.",
      },
    ],
  },
  ...
  "v-l6b": {
    ...
    gemella: "r-l6b",
    testo: "Quali informazioni definiscono un titolo di Stato?",
    corretta: "b",
    opzioni: [
      {
        id: "a",
        testo: "Il numero di cittadini che lo hanno acquistato e la quota di ciascuno",
        lacuna: "titolo-stato",
        spiegazione: "Un titolo di Stato non assegna quote a nessuno: definisce un prestito, con le sue condizioni.",
      },
      {
        id: "b",
        testo: "L’emittente, la cedola, la scadenza e il capitale nominale",
        spiegazione: "Sono le quattro parti della lezione: chi si impegna a restituire, quanto paga nel frattempo, quando termina il prestito e quale somma viene restituita.",
      },
      {
        id: "c",
        testo: "Il prezzo di borsa di oggi e quello di domani",
        lacuna: "titolo-stato",
        spiegazione: "Il prezzo di mercato cambia nel tempo, ma non è ciò che definisce il titolo: le sue parti sono fissate al momento dell’emissione.",
      },
      {
        id: "d",
        testo: "Il nome della banca presso cui lo hai comprato",
        lacuna: "titolo-stato",
        spiegazione: "L’intermediario presso cui acquisti non fa parte dello strumento. L’emittente, cioè chi si impegna a restituire, è lo Stato.",
      },
    ],
  },
  ...
  "r-l1b": {
    ...
    concetto: "potere-acquisto",
    gemella: "v-l1b",
    testo: "Qualche anno fa un abbonamento mensile costava 30 euro. Oggi lo stesso abbonamento costa 34 euro. In tasca hai sempre una banconota da 50 euro. Che cosa è cambiato?",
    corretta: "b",
    opzioni: [
      {
        id: "a",
        testo: "Niente: la banconota vale sempre 50 euro",
        lacuna: "potere-acquisto",
        spiegazione: "Il numero stampato sulla banconota, cioè il valore nominale, non è cambiato. Quello che quella cifra riesce a comprare sì.",
      },
      {
        id: "b",
        testo: "Il valore nominale della banconota è lo stesso, ma con quella cifra compri meno di prima",
        spiegazione: "È la distinzione tra valore nominale e potere d’acquisto: il numero resta 50, ciò che ci ottieni si è ridotto.",
      },
      {
        id: "c",
        testo: "La banconota è stata svalutata da chi l’ha emessa",
        lacuna: "potere-acquisto",
        spiegazione: "Nessuno ha modificato la banconota. È il prezzo dell’abbonamento a essere salito, e questo cambia quante cose la stessa cifra può comprare.",
      },
      {
        id: "d",
        testo: "Il potere d’acquisto è aumentato, perché l’abbonamento costa di più",
        lacuna: "potere-acquisto",
        spiegazione: "Quando i prezzi salgono il potere d’acquisto scende: con la stessa somma ottieni meno di prima, non di più.",
      },
    ],
  },
  ...
  "r-l2a": {
    ...
    concetto: "inflazione",
    gemella: "v-l2a",
    testo: "L’inflazione pubblicata per l’anno è del 3%, ma a te sembra di spendere molto di più rispetto all’anno scorso. Come può succedere?",
    corretta: "b",
    opzioni: [
      {
        id: "a",
        testo: "Il dato pubblicato è sbagliato",
        lacuna: "inflazione",
        spiegazione: "Il dato misura un paniere medio. Non descrive la spesa di nessuna famiglia in particolare, quindi può non coincidere con la tua senza per questo essere errato.",
      },
      {
        id: "b",
        testo: "Il 3% è una media su un paniere standard: se spendi soprattutto in voci rincarate più della media, la tua inflazione personale è diversa",
        spiegazione: "L’indice pesa le voci secondo la spesa media. La tua spesa ha pesi diversi, quindi il tuo aumento può essere più alto o più basso di quello pubblicato.",
      },
      {
        id: "c",
        testo: "L’inflazione riguarda solo i prezzi all’ingrosso, non quelli dei negozi",
        lacuna: "inflazione",
        spiegazione: "L’indice dei prezzi al consumo rileva proprio i prezzi che paga chi acquista, non quelli all’ingrosso.",
      },
      {
        id: "d",
        testo: "Perché il 3% si applica una sola volta, il primo giorno dell’anno",
        lacuna: "inflazione",
        spiegazione: "L’inflazione è un aumento continuato e distribuito nel tempo, non uno scatto in una data precisa.",
      },
    ],
  },
  ...
  "r-l6a": {
    ...
    concetto: "prestito",
    gemella: "v-l6a",
    testo: "Nella stessa azienda, una persona possiede azioni e un’altra possiede obbligazioni. Che cosa distingue le due posizioni?",
    corretta: "c",
    opzioni: [
      {
        id: "a",
        testo: "Nulla: entrambe hanno messo denaro nella stessa azienda",
        lacuna: "prestito",
        spiegazione: "L’azienda è la stessa, il ruolo no: una è socia, l’altra è creditrice. Sono due rapporti con diritti diversi.",
      },
      {
        id: "b",
        testo: "Chi ha le obbligazioni possiede una parte più piccola dell’azienda",
        lacuna: "prestito",
        spiegazione: "Chi ha obbligazioni non possiede alcuna parte dell’azienda: le ha prestato denaro.",
      },
      {
        id: "c",
        testo: "Chi ha le azioni possiede una quota dell’azienda; chi ha le obbligazioni le ha prestato denaro e attende la restituzione a scadenza",
        spiegazione: "Proprietario e creditore sono i due ruoli della lezione. La stessa azienda può emettere entrambi gli strumenti: quello che cambia è il tuo rapporto con lei.",
      },
      {
        id: "d",
        testo: "Chi ha le azioni ha diritto a una cedola, chi ha le obbligazioni a un dividendo",
        lacuna: "proprieta",
        spiegazione: "È invertito: la cedola è il pagamento periodico di un’obbligazione, il dividendo è l’eventuale distribuzione di utili ai soci.",
      },
    ],
  },
