...
export const CARTELLE = {
  ...
  "agents/src": "Il codice degli agenti programmatici.",
  "agents/src/agenti": "Un agente per file: prompt di sistema e funzione che lo invoca.",
  "agents/src/catene": "Più agenti in sequenza, dove l'uscita di uno entra nel successivo.",
  ...
  "presentazione/guida/brand": "Copia del design system, perché la guida sia apribile da sola.",
  "presentazione/guida/brand/assets": "Font e logo serviti alla guida.",
  "presentazione/theme": "Il tema Accenture per le slide Reveal.js.",
};
...
export const FILE = {
  ...
  // ---------- agents/ ----------
  "agents/README.md": "Come si lanciano gli agenti programmatici e cosa fanno.",
  "agents/package.json": "Dipendenze e script degli agenti: qui vive l'Agent SDK TypeScript.",
  "agents/src/cli.ts": "La riga di comando degli agenti: instrada gli argomenti verso l'agente o la catena giusta.",
  "agents/src/client.ts": "Crea il client Anthropic alla prima chiamata, non all'import: così i comandi che non parlano col modello non richiedono una chiave.",
  "agents/src/agenti/semplificatore.ts": "Riscrive testi in italiano semplice per chi parte da zero: frasi sotto le 20 parole, voce attiva, niente gergo.",
  "agents/src/catene/lezione.ts": "Catena che genera una lezione completa — concetto, esempio, domanda — e la fa passare dal semplificatore.",
  ...
  // ---------- presentazione/ ----------
  "presentazione/README.md": "Come si lancia e si modifica il deck.",
  "presentazione/index.html": "Le slide della presentazione finale, in Reveal.js.",
  "presentazione/theme/accenture.css": "Il tema Accenture per Reveal.js: token del brand, font reali e stili delle slide.",
  "presentazione/guida/index.html": "Questa guida.",
  "presentazione/guida/brand/accenture.css": "Copia del design system, perché la guida resti apribile anche da sola.",
  "presentazione/guida/brand/assets/fonts.css": "Le regole @font-face dei font serviti alla guida.",
};
